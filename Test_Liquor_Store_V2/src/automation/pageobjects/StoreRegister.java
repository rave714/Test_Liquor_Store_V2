...
public class StoreRegister extends Command {
    ...
    By ele_lblValidationText = By.xpath("//*[@id=\"welcome\"]/h1");
 ...
 */
		...
		public void storeRegister_details (WebDriver driver, String fname, String lname, String email, String password, String cpassword  ) throws IOException {
		...
		public void storeRegister_verifydetails(WebDriver driver, String expectedText) throws IOException   {
