...
public class all01 {
  ...
  public void testRegisterPage() throws Exception {
    ...
    driver.get("http://localhost/liquor-store-app-main/register.php");
    driver.findElement(By.name("fname")).click();
    driver.findElement(By.name("fname")).clear();
    driver.findElement(By.name("fname")).sendKeys("raveen");
    driver.findElement(By.name("lname")).click();
   
    driver.findElement(By.name("lname")).sendKeys("jayasooriya");
    driver.findElement(By.name("email")).click();
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("raveen@gh.lk");
    driver.findElement(By.name("password")).click();
    driver.findElement(By.name("password")).clear();
    driver.findElement(By.name("password")).sendKeys("raveen123");
    driver.findElement(By.name("cpassword")).click();
    driver.findElement(By.name("cpassword")).clear();
    driver.findElement(By.name("cpassword")).sendKeys("raveen123");
    driver.findElement(By.name("submit")).click();
    driver.get("http://localhost/liquor-store-app-main/welcome.php");
